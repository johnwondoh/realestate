...
async function getProperties(page: number = 1, sortBy: string = 'featured') {
    ...
    switch (sortBy) {
        case 'price-low':
            orderByClause = properties.minPrice;
            break;
        case 'price-high':
            orderByClause = desc(properties.minPrice);
            break;
        case 'newest':
            orderByClause = desc(properties.listedDate);
            break;
        case 'oldest':
            orderByClause = properties.listedDate;
            break;
        default: // 'featured'
    ...
    const propertiesData = await db
        ...
        .where(eq(properties.status, 'buy'))
...
export default async function PropertiesPage({ searchParams }: PageProps) {
    ...
    const { properties: propertiesData, totalCount, totalPages } = await getProperties(
        currentPage,
        sortBy
    );
                        ...
                        <div className="md:col-span-9 p-6">
                            <div className="mb-4 space-y-6">
                                {propertiesData.length === 0 ? (
                                    ...
                                    propertiesData.map(({ property, agent, agency }) => (
                                        <Card
                                            key={property.id}
...
//         images: ["/houses/1.smallmodhomesFEAT.jpg", "/houses/101318214_preview-6e44a19fb4af42559cdf1b749a7e9148.jpg"],
//         priceMin: 420000,
//         priceMax: 450000,
...
//                         </div>
//                         <div className="md:col-span-3">
//                             <div className="h-96 bg-red sticky md:sticky md:top-6 "></div>
//                         </div>
//                     </div>
//                 </section>
//
